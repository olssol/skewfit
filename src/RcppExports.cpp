...
// fit_para_skew_old
List fit_para_skew_old(NumericVector init_pa, NumericVector y, NumericVector x, NumericMatrix z, int usez, int max_steps, double tol);
RcppExport SEXP _skewfit_fit_para_skew_old(SEXP init_paSEXP, SEXP ySEXP, SEXP xSEXP, SEXP zSEXP, SEXP usezSEXP, SEXP max_stepsSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(fit_para_skew_old(init_pa, y, x, z, usez, max_steps, tol));
    return rcpp_result_gen;
END_RCPP
}
// fit_para_skew
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_skewfit_fit_para_skew_old", (DL_FUNC) &_skewfit_fit_para_skew_old, 7},
